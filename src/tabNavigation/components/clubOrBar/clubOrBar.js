...
import { View, Text, Image, ImageBackground, FlatList, Dimensions, TouchableOpacity } from 'react-native';

import style from './style';

let {height, width}=Dimensions.get("window");

export default class ClubOrBar extends React.Component{
            ...
            data:[
                {
                    ...
                    event:"John Doe's 28th B'day party Event.",
            ...
            <View style={{flex:1}}>
                <FlatList
                    ...
                    renderItem={({index, item})=>{
                        return(
                            <TouchableOpacity
                                style={{height:height*0.3, width:"100%", paddingHorizontal:5}}
                                onPress={()=>{
                            ...
                            >
                                <View style={{position:"absolute", top:10, left:0, flexDirection:"row", zIndex:20}}>
                                    <View style={{height:20, width:60, backgroundColor:"rgb(223, 35, 125)", justifyContent:"center", paddingLeft:10}}>
